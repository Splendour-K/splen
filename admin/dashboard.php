    ...
    <div class="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row gap-8 py-8 w-full">
        ...
        <main class="flex-1 space-y-8">
            <header class="p-8 bg-white dark:bg-gray-900 rounded-[2.5rem] border border-gray-100 dark:border-gray-800 shadow-sm relative overflow-hidden">
                ...
                <div class="relative">
                    <h2 class="text-3xl font-black text-gray-900 dark:text-white">Live Overview</h2>
                    <p class="text-gray-500 font-bold mt-1">Real-time platform performance and management.</p>
                </div>
            </header>
            ...
            <div class="grid grid-cols-2 md:grid-cols-6 gap-6">
                <div class="p-8 bg-white dark:bg-gray-900 rounded-[2.5rem] border border-gray-100 dark:border-gray-800 shadow-sm">
                    ...
                    <h3 class="text-3xl font-black text-gray-900 dark:text-white">$<?php echo number_format($total_revenue); ?></h3>
                </div>
                <div class="p-8 bg-gray-900 rounded-[2.5rem] text-white shadow-xl">
                    ...
                    <h3 class="text-3xl font-black">$<?php echo number_format($admin_commission); ?></h3>
                </div>
                <div class="p-8 bg-white dark:bg-gray-900 rounded-[2.5rem] border border-gray-100 dark:border-gray-800 shadow-sm">
                    <p class="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2">Active Creators</p>
                    <h3 class="text-3xl font-black text-gray-900 dark:text-white"><?php echo $total_creators; ?></h3>
                </div>
                <div class="p-8 bg-white dark:bg-gray-900 rounded-[2.5rem] border border-gray-100 dark:border-gray-800 shadow-sm">
                    <p class="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2">Active Briefs</p>
                    <h3 class="text-3xl font-black text-gray-900 dark:text-white"><?php echo $active_campaigns; ?></h3>
                </div>
                <div class="p-8 bg-white dark:bg-gray-900 rounded-[2.5rem] border border-gray-100 dark:border-gray-800 shadow-sm <?php echo $pending_contests > 0 ? 'border-b-4 border-b-orange-500' : ''; ?>">
                    ...
                    <h3 class="text-3xl font-black text-gray-900 dark:text-white"><?php echo $pending_contests; ?></h3>
                </div>
                <div class="p-8 bg-white dark:bg-gray-900 rounded-[2.5rem] border border-gray-100 dark:border-gray-800 shadow-sm <?php echo $pending_ugc > 0 ? 'border-b-4 border-b-orange-500' : ''; ?>">
                    ...
                    <h3 class="text-3xl font-black text-gray-900 dark:text-white"><?php echo $pending_ugc; ?></h3>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <section class="lg:col-span-2 p-8 bg-white dark:bg-gray-900 rounded-[2.5rem] border border-gray-100 dark:border-gray-800 shadow-sm">
                    <h4 class="text-sm font-black uppercase tracking-widest text-gray-400 mb-6">Submission & Payment Reviews</h4>
                    <div class="space-y-3">
                        <a href="<?php echo APP_URL; ?>admin/contest-submissions.php" class="block p-4 bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-2xl hover:bg-orange-100 dark:hover:bg-orange-900/40 transition">
                            ...
                            <p class="text-sm text-orange-700 dark:text-orange-300 mt-1">Review <?php echo $pending_contests; ?> pending submission<?php echo $pending_contests !== 1 ? 's' : ''; ?></p>
                        </a>
                        <a href="<?php echo APP_URL; ?>admin/ugc-submissions.php" class="block p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-2xl hover:bg-blue-100 dark:hover:bg-blue-900/40 transition">
                            ...
                            <p class="text-sm text-blue-700 dark:text-blue-300 mt-1">Review <?php echo $pending_ugc; ?> pending submission<?php echo $pending_ugc !== 1 ? 's' : ''; ?></p>
                        </a>
                        <a href="<?php echo APP_URL; ?>admin/cpm-payouts.php" class="block p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-2xl hover:bg-green-100 dark:hover:bg-green-900/40 transition">
                            ...
                            <p class="text-sm text-green-700 dark:text-green-300 mt-1">Calculate <?php echo $pending_cpm; ?> pending CPM calculation<?php echo $pending_cpm !== 1 ? 's' : ''; ?></p>
                        </a>
                        <a href="<?php echo APP_URL; ?>admin/payment-verification.php" class="block p-4 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-2xl hover:bg-purple-100 dark:hover:bg-purple-900/40 transition">
                            ...
                            <p class="text-sm text-purple-700 dark:text-purple-300 mt-1">Verify <?php echo $pending_payments; ?> pending payment<?php echo $pending_payments !== 1 ? 's' : ''; ?></p>
                        </a>
                    </div>
                </section>
                 ...
                 <section class="p-8 bg-white dark:bg-gray-900 rounded-[2.5rem] border border-gray-100 dark:border-gray-800 shadow-sm">
                    <h4 class="text-sm font-black uppercase tracking-widest text-gray-400 mb-6">Recent Activity</h4>
                    <div class="space-y-4">
                        <?php foreach ($logs as $log): ?>
                            <div class="flex items-start gap-4 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-2xl border border-gray-100 dark:border-gray-700">
                                <div class="w-8 h-8 rounded-lg bg-orange-100 text-orange-600 flex items-center justify-center text-xs">⚡</div>
                                <div>
                                    <p class="text-xs font-bold text-gray-900 dark:text-white"><?php echo e($log["action"]); ?></p>
                                    <p class="text-[10px] text-gray-500"><?php echo e($log["email"]); ?> • <?php echo time_ago($log["created_at"]); ?></p>
                                </div>
                            </div>
                        <?php endforeach; ?>
                        <?php if (empty($logs)): ?>
